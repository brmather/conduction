...
class Conduction3D(object):
    ...
    def __init__(self, minCoord, maxCoord, res):
        ...
        # local coordinates
        self.coords = dm.getCoordinatesLocal().array.reshape(-1,3)
    ...
    def boundary_condition(self, wall, val, flux=True):
        ...
        if self.bc.has_key(str(wall)):
            ...
            if flux:
                ...
                # self.dirichlet_mask[ds:de,rs:re,cs:ce] = False
                # self.corner_mask[dr[0], rr[0], cr[0]]  = False
                # self.corner_mask[dr[-1],rr[0], cr[0]]  = False
                # self.corner_mask[dr[0], rr[-1],cr[0]]  = False
                # self.corner_mask[dr[0], rr[0], cr[-1]] = False
                # self.corner_mask[dr[0], rr[-1],cr[-1]] = False
                # self.corner_mask[dr[-1],rr[0], cr[-1]] = False
                # self.corner_mask[dr[-1],rr[-1],cr[0]]  = False
                # self.corner_mask[dr[-1],rr[-1],cr[-1]] = False
                
                self.bc[str(wall)]["val"] /= -d['delta']
            else:
                self.dirichlet_mask[mask] = True
                # self.corner_mask[dr[0], rr[0], cr[0]]  = True
                # self.corner_mask[dr[-1],rr[0], cr[0]]  = True
                # self.corner_mask[dr[0], rr[-1],cr[0]]  = True
                # self.corner_mask[dr[0], rr[0], cr[-1]] = True
                # self.corner_mask[dr[0], rr[-1],cr[-1]] = True
                # self.corner_mask[dr[-1],rr[0], cr[-1]] = True
                # self.corner_mask[dr[-1],rr[-1],cr[0]]  = True
                # self.corner_mask[dr[-1],rr[-1],cr[-1]] = True
                # self.dirichlet_mask -= self.corner_mask
